...
<body class="text-center">
    ...
    <div class="signin_header">
        ...
        <p class="font_24">New to Eveien? <a href="/eveien/checkin">Sign Up</a></li></p>
    </div>
    <div class="signin_col signin_border">
        <div>
            <div class="inputTxt">
    <div class="inputTxt_colLabel">
        <label for="{{ 'name' }}" class="inputTxt_label">First Name</label>
    </div>
    <div class="inputTxt_colInput">
        <input type="text" id="{{ 'name' }}" name="{{ 'name' }}" placeholder="Your name.." onchange="{{ 'inputTxtID' }}()">
        <span id="{{ 'inputTxtID' }}"></span>
    </div>
</div>
            <div class="inputTxt">
    <div class="inputTxt_colLabel">
        <label for="{{ 'name' }}" class="inputTxt_label">First Name2</label>
    </div>
    <div class="inputTxt_colInput">
        <input type="text" id="{{ 'name' }}" name="{{ 'name' }}" placeholder="Your name.." onchange="{{ 'inputTxtID' }}()">
        <span id="{{ 'inputTxtID' }}"></span>
            ...
            <div class="button">
    <button type="submit" name="Logkin">Log in</button>
</div>
